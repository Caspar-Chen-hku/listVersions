...
func TestLatestVersions(t *testing.T) {
	testCases := []struct {
		...
		{
			versionSlice:   []string{"1.8.11", "1.9.6", "1.10.1", "1.9.5", "1.8.10", "1.10.0", "1.7.14", "1.8.9", "1.9.5", "2.3.1","2.3.0"},
			expectedResult: []string{"2.3.1"},
			minVersion:     semver.New("2.2.1"),			
		},
		{
			versionSlice:   []string{"1.8.11", "1.9.6", "1.10.1", "1.9.5", "1.8.10", "1.10.0", "1.7.14", "1.8.9", "1.9.5", "2.3.1","2.3.0"},
			expectedResult: []string{},
			minVersion:     semver.New("2.4.1"),			
		},
		{
			versionSlice:   []string{"1.8.11", "1.9.6", "1.10.1", "1.9.5", "1.8.10", "1.10.0", "1.7.14", "1.8.9", "1.9.5", "2.3.1","2.3.0"},
			expectedResult: []string{"2.3.1","1.10.1","1.9.6","1.8.11","1.7.14"},
